           ...
           <a href="<?= site_url('dashboard_admin'); ?>" type="submit" class="btn btn-primary btn-sm mb-2"><i class="fa fa-undo"></i> Kembali</a>
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tr style="font-size: 13px;">
                  ...
                  <td align="center">
                    <?php if($dr->status_reseller == 0) { ?>
                        <a href="<?php echo site_url('manajemen_admin/update_aktif_reseller/' . $dr->id_reseller); ?>" class="badge badge-danger tombol-aktif" style="font-size: 12px;">Account Inactive</a>
                    <?php } ?>

                    <a href="<?php echo site_url('dashboard_admin/detail_reseller_pending'); ?>/<?= $dr->id_reseller?>" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> Detail</a>
