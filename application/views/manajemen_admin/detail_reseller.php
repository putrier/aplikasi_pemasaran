    ...
    <section class="content">
      ...
      <div class="col-md-3">
        <div class="card">
          ...
          <div class="card-body">
             <img class="profile-user-img img-responsive img-circle img-center mx-auto d-block" src="<?= base_url() ?>upload/foto_reseller/<?= $reseller['foto_reseller'] ?>" alt="User profile picture" style="height: 110px;">
      ...
      <div class="col-sm-9">
        ...
        <div class="box-footer">
            <div class="pull-left mb-3">
                <a href="<?php echo site_url('manajemen_admin/data_reseller'); ?>" type="submit" class="btn btn-primary btn-sm"><i class="fa fa-undo"></i> Kembali</a>
            </div>
        </div>
      </div>
    </div>
